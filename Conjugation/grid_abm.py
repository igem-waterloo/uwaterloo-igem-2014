...
from hex_plot import hex_plotter
from data_plot import data_plotter
...
plot_hex_folder = current_run_folder + "plot_hex\\"
plot_data_folder = current_run_folder + "plot_data\\"

dir_list = [runs_folder, current_run_folder, data_folder, plot_hex_folder, plot_data_folder]
...
class Cell(object):
    ...
    # given cell # i,j, returns a list of array pairs (up to 6) rep nearby hex cells
